...
| **DP-004** | KMS Key Rotation | Automatic rotation per classification: annual (public), quarterly (PCI), monthly (restricted) | Data | ✓ | ✓ | ✓ | ✅ | [org/shared-services/kms-shared.tf](../org/shared-services/kms-shared.tf) (rotation_period_in_days) |
...
| Key Rotation | [org/shared-services/kms-shared.tf](../org/shared-services/kms-shared.tf) | Automatic per classification |
